# Assessment2 - Back-end automation Wizeline Academy
...
1. To run the tests and see the results in an html report run the following command `npm run report -- --env-var "apiKey=VALUE_OF_VALID_APIKEY"` the report will be saved inside the reports folder.